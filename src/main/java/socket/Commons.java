...
import socket.client.component.CharsetByteRelative;
import socket.client.sender.BFileSender;
import socket.client.sender.DefaultSender;
import socket.client.sender.FileSender;
import socket.client.sender.GetFileSender;
import socket.client.sender.MessageSender;
